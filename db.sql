...
ALTER TABLE `posts` ADD `auteur_id` INT(11); 
ALTER TABLE `posts` ADD FOREIGN KEY (`auteur_id`) REFERENCES auteurs(`id`);
...
ALTER TABLE `posts` ADD `likes` INT(11) NOT NULL DEFAULT '0' AFTER `auteur_id`; 
...
ALTER TABLE `posts_tags` ADD FOREIGN KEY (`post_id`) REFERENCES `posts`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; 
ALTER TABLE `posts_tags` ADD FOREIGN KEY (`tag_id`) REFERENCES `tags`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; 